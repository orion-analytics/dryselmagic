 ...
 */
package com.orchestral.automation.dryselmagic.model.annotations;
...
public @interface MagicTestOptions {
	// base path to test description files
	String pathOfTestDescriptions();

	// base path to json files containing test objects
	String pathOfTestObjects();
}
